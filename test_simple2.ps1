...
$gr = Invoke-RestMethod -Uri 'http://localhost:8088/api/v1/security/guest_token/' -Method Post -ContentType 'application/json' -Body $gbody -Headers @{'Authorization'=('Bearer '+$tok); 'X-CSRFToken'=$csrf; 'Referer'='http://localhost:8088/'}
$gtok = $gr.token
