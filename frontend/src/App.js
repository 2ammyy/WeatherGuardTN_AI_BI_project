      ...
      <main className={`main-content ${sidebarCollapsed ? 'expanded' : ''}`}>
        {currentPage === 'home' ? (
          <div className="home-page">
            ...
            <div className="vigilance-card">
              <h2>
                <i className="fas fa-map"></i> Live vigilance map · Tunisia
              </h2>
                  ...
                  <div className="map-placeholder-enhanced">
                    ...
                    <div className="map-grid">
                      ...
                      <div className="map-row">
                        <div className="map-cell" data-risk={getGovRisk('Bizerte')}>Bizerte</div>
                        <div className="map-cell" data-risk={getGovRisk('Tunis')}>Tunis</div>
                        <div className="map-cell" data-risk={getGovRisk('Ariana')}>Ariana</div>
                        <div className="map-cell" data-risk={getGovRisk('Manouba')}>Manouba</div>
                      </div>
                      <div className="map-row">
                        <div className="map-cell" data-risk={getGovRisk('Nabeul')}>Nabeul</div>
                        <div className="map-cell" data-risk={getGovRisk('Zaghouan')}>Zaghouan</div>
                        <div className="map-cell" data-risk={getGovRisk('Beja')}>Béja</div>
                        <div className="map-cell" data-risk={getGovRisk('Jendouba')}>Jendouba</div>
                      </div>
                      
                      {/* Row 2: Northwest/Central */}
                      <div className="map-row">
                        <div className="map-cell" data-risk={getGovRisk('Kef')}>Le Kef</div>
                        <div className="map-cell" data-risk={getGovRisk('Siliana')}>Siliana</div>
                        <div className="map-cell" data-risk={getGovRisk('Sousse')}>Sousse</div>
                        <div className="map-cell" data-risk={getGovRisk('Monastir')}>Monastir</div>
                      </div>
                      <div className="map-row">
                        <div className="map-cell" data-risk={getGovRisk('Mahdia')}>Mahdia</div>
                        <div className="map-cell" data-risk={getGovRisk('Sfax')}>Sfax</div>
                        <div className="map-cell" data-risk={getGovRisk('Kairouan')}>Kairouan</div>
                        <div className="map-cell" data-risk={getGovRisk('Kasserine')}>Kasserine</div>
                      </div>
                      
                      {/* Row 3: Central/South */}
                      <div className="map-row">
                        <div className="map-cell" data-risk={getGovRisk('Sidi Bouzid')}>Sidi Bouzid</div>
                        <div className="map-cell" data-risk={getGovRisk('Gafsa')}>Gafsa</div>
                        <div className="map-cell" data-risk={getGovRisk('Tozeur')}>Tozeur</div>
                        <div className="map-cell" data-risk={getGovRisk('Kebili')}>Kébili</div>
                      </div>
                      
                      {/* Row 4: South */}
                      <div className="map-row">
                        <div className="map-cell" data-risk={getGovRisk('Gabes')}>Gabès</div>
                        <div className="map-cell" data-risk={getGovRisk('Medenine')}>Médenine</div>
                        <div className="map-cell" data-risk={getGovRisk('Tataouine')}>Tataouine</div>
                        <div className="map-cell" data-risk="info">Mediterranean Sea</div>
                      </div>
                    </div>
                    ...
                    <div className="map-overlay">
                      <div className="map-legend">
                        <span><span className="legend-dot green"></span> Green - Safe</span>
                        <span><span className="legend-dot yellow"></span> Yellow - Be Aware</span>
                        <span><span className="legend-dot orange"></span> Orange - Be Prepared</span>
                        <span><span className="legend-dot red"></span> Red - Take Action</span>
                        <span><span className="legend-dot purple"></span> Purple - Extreme</span>
                      </div>
                    </div>
                    ...
                    <div className="map-title">
                      ...
                      Governorate Risk Levels · {new Date().toLocaleTimeString()}
                    </div>
                  </div>
                )}
              </div>

              {/* Neighbor Influence Footer */}
              <div className="map-footer-enhanced">
                <div className="neighbor-flags">
                  <span><i className="fas fa-flag"></i> 🇩🇿 Algeria <small>(NW influence)</small></span>
                  <span><i className="fas fa-flag"></i> 🇱🇾 Libya <small>(SE influence)</small></span>
                  <span><i className="fas fa-flag"></i> 🇮🇹 Italy <small>(NE influence)</small></span>
                  <span><i className="fas fa-flag"></i> 🇲🇹 Malta <small>(Coastal)</small></span>
                </div>
                <p className="map-update">
                  <i className="fas fa-sync-alt fa-spin"></i> 
                  Updated with neighbour influence · {apiStatus === 'connected' ? 'Live data' : 'Local forecast'}
                </p>
              </div>
            </div>
